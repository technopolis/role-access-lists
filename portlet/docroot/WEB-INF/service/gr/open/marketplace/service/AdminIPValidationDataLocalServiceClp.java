 ...
 * @author cotria
 */
public class AdminIPValidationDataLocalServiceClp
	implements AdminIPValidationDataLocalService {
	public AdminIPValidationDataLocalServiceClp(
	...
	public gr.open.marketplace.model.AdminIPValidationData addAdminIPValidationData(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] {
						ClpSerializer.translateInput(adminIPValidationData)
					});
		}
		catch (Throwable t) {
		...
		return (gr.open.marketplace.model.AdminIPValidationData)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<gr.open.marketplace.model.AdminIPValidationData> getAdminIPValidationDatas(
		...
		return (java.util.List<gr.open.marketplace.model.AdminIPValidationData>)ClpSerializer.translateOutput(returnObj);
	}
