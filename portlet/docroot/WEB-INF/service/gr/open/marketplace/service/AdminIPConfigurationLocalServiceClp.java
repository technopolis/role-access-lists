 ...
 * @author cotria
 */
public class AdminIPConfigurationLocalServiceClp
	implements AdminIPConfigurationLocalService {
	public AdminIPConfigurationLocalServiceClp(
		...
		_methodName19 = "getAdminIPConfiguration";
	...
	public gr.open.marketplace.model.AdminIPConfiguration addAdminIPConfiguration(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] {
						ClpSerializer.translateInput(adminIPConfiguration)
					});
		}
		catch (Throwable t) {
		...
		return (gr.open.marketplace.model.AdminIPConfiguration)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<gr.open.marketplace.model.AdminIPConfiguration> getAdminIPConfigurations(
		...
		return (java.util.List<gr.open.marketplace.model.AdminIPConfiguration>)ClpSerializer.translateOutput(returnObj);
	}
